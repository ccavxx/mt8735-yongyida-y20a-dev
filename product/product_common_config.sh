...
#kernel-3.10
if [ -d yongyida/product/$CUSTOMER_PRODUCT/diff/kernel-3.10 ]; then
	cp  -rf yongyida/product/$CUSTOMER_PRODUCT/diff/kernel-3.10/* kernel-3.10/
fi
#***************************************************************************************************************
...
#******************  init.mt6752.rc  *************************************************************
if [ -e yongyida/product/$CUSTOMER_PRODUCT/config/init.mt6752.rc ]; then
	cp  -rf yongyida/product/$CUSTOMER_PRODUCT/config/init.mt6752.rc $MTK_PROJECT_PATH/init.mt6752.rc
fi
#***************************************************************************************************************
...
. yongyida/tools/modify_config_before_make.sh $CUSTOMER_PRODUCT/config/modifyconfigs_before_build
fi
