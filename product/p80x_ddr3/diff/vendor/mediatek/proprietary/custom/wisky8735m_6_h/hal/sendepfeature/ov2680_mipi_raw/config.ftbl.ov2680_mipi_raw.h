...
#ifndef _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_OV2680_CONFIGFTBL__H_
#define _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_OV2680_CONFIGFTBL__H_
//#if 1
//
 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_OV2680_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::EFFECT_F1977 ,
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
            	// 4:3
                "320x240",      "640x480",     "1024x768", 	"1280x960", "1600x1200",
				// 3:2
				"480x320", 		"960x640", 		"1440x960",
				// 5:3
				"800x480", "1600x960",
				// 16:9
                "1280x720",     "1280x768",    "1920x1088"
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "960x540",      "960x640",      "1280x720",     "1440x960",     "1440x1080",    
                "1600x960", "1600x1200",	"1920x1088",
            )
        ), 
    )
#endif
