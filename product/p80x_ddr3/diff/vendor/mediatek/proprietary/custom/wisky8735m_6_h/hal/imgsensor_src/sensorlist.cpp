...
{
// dongkang@wisky.com.cn,2015-1-19 main and sub sensor are the same, but not the same module
#if defined(GC2355F_MIPI_RAW)
    RAW_INFO(GC2355F_SENSOR_ID, SENSOR_DRVNAME_GC2355F_MIPI_RAW,NULL), 
#endif
#if defined(GC2355B_MIPI_RAW)
    RAW_INFO(GC2355B_SENSOR_ID, SENSOR_DRVNAME_GC2355B_MIPI_RAW,NULL), 
#endif
