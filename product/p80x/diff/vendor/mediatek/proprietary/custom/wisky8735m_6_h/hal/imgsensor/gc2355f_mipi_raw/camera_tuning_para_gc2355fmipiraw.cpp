...
#include "camera_AE_PLineTable_gc2355fmipiraw.h"
#include "camera_info_gc2355fmipiraw.h"
...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        512,      // i4B_MIN
        {  // i4P00[9]
            5155043, -2046035, -549008, -927070, 4514129, -1027059, -335965, -1524246, 4420211
        },
        {  // i4P10[9]
            0,  0, 0, 0,  0,  0, 0,   0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AWB NVRAM
    {
		...
		-143,	// i4SlopeNumerator		
			...
			74,	// PCloudyLeftBound				            
			-163,	// PCloudyUpperBound				        
			-290	// PCloudyLowerBound				        
                    },
                    // Shade
                    {
			349,	// PShadeRightBound				          
			74,	// PShadeLeftBound				          
			-163,	// PShadeUpperBound				          
			-290	// PShadeLowerBound				          
                    },
                    // Twilight
                    {
			-74,	// PTwiRightBound				            
			...
			-364	// PFluoLowerBound				          
                    ...
                    // Warm fluorescent
                    {
			-205,	// PWFluoRightBound				          
			-405,	// PWFluoLeftBound				          
			-153,	// PWFluoUpperBound				          
			-364	// PWFluoLowerBound				          
                    },
                    // Incandescent
                    {
			-205,	// PIncaRightBound				          
