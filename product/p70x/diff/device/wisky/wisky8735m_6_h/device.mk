...
# PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/ueventd.mt6735.rc:root/ueventd.mt6735.rc

PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/wisky/wisky8735m_6_h/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif
...
#PRODUCT_COPY_FILES += device/wisky/$(MTK_TARGET_PROJECT)/MT6735_Android_scatter.txt:MT6735_Android_scatter.txt
...
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8735m_6_h/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8735m_6_h/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6735/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# CTS 
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/handheld_core_hardware.xml:system/etc/permissions/handheld_core_hardware.xml

# Audio Policy
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/audio_policy.conf:system/etc/audio_policy.conf

#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8735m_6_h/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8735m_6_h/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8735m_6_h/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8735m_6_h/factory/res/images/lcd_test_03.png:system/res/images/lcd_test_03.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8735m_6_h/factory/res/images/lcd_test_04.png:system/res/images/lcd_test_04.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8735m_6_h/factory/res/images/lcd_test_05.png:system/res/images/lcd_test_05.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8735m_6_h/factory/res/images/lcd_test_06.png:system/res/images/lcd_test_06.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8735m_6_h/factory/res/images/lcd_test_07.png:system/res/images/lcd_test_07.png

# Thermal
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/thermal.conf:system/etc/.tp/thermal.conf
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/thermal.off.conf:system/etc/.tp/thermal.off.conf
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/ht120.mtc:system/etc/.tp/.ht120.mtc
#media_codecs.xml for video codec support
PRODUCT_COPY_FILES += device/wisky/wisky8735m_6_h/media_codecs.xml:system/etc/media_codecs.xml

# overlay has priorities. high <-> low.

DEVICE_PACKAGE_OVERLAYS += device/mediatek/common/overlay/sd_in_ex_otg

DEVICE_PACKAGE_OVERLAYS += device/wisky/wisky8735m_6_h/overlay
