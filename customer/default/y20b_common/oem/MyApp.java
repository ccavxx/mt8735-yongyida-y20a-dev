...
public class MyApp extends Application {
    ...
    private void initVariable() {
        ...
        wk.setThresholdValue(value);                   //设置初始唤醒门限值
    ...
    private void getAccount() {
        ...
        String gsm = SystemProperties.get("gsm.serial", "y20a_dev");

        if (gsm.equals("y20a_dev")) {
...
//		}
    ...
    private String getId(String gsm) {
        try {
            final String sdKey = gsm.substring(0, 32);
    ...
    private void initSpeech() {
        ...
        if (RobotStateData.mRotorVoiceKey == RobotStateData.VOICE_KEY_XIAOYONG) {
            //小勇小勇
            SpeechUtility.createUtility(MyApp.this, SpeechConstant.APPID + "=561385ab");
