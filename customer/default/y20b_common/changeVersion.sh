...
changeBuildinfo
changeSystemProp
cp -rf $CUSTOMIZATION_PATH/oem/MyApp.java packages/apps/YYDRobotVoiceMainService/$CUR_PROJECT/java/com/yongyida/robot/voice/app/MyApp.java
cp -rf $CUSTOMIZATION_PATH/oem/VoiceWakeUp.java packages/apps/YYDRobotVoiceMainService/$CUR_PROJECT/java/com/yongyida/robot/voice/frame/iflytek/VoiceWakeUp.java
cp -rf $CUSTOMIZATION_PATH/oem/xiaoyong.jet packages/apps/YYDRobotVoiceMainService/$CUR_PROJECT/assets/ivw/xiaoyong.jet
